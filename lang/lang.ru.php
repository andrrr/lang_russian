<?php
	...
	$dictionary = array(
		...
		'%s включая записи в подразделах',
		...
		'Ваша версия Symphony уже установлена, но установщик не удалён. По соображениям безопасности он будет удалён.',
		...
		'Запращиваемая страница не существует.',
